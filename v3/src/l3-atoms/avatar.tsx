...
const avatarVariants = cva(
  'relative inline-flex shrink-0 select-none items-center justify-center rounded-full font-medium',
  {
    ...
    variants: {
      size: {
        default: 'h-8 w-8 gds-text-label',
        lg: 'h-10 w-10 gds-text-body',
        sm: 'h-6 w-6 gds-text-caption',
        xs: 'h-5 w-5 gds-text-caption',
      },
    },
  }
)
...
export const Avatar = forwardRef<HTMLSpanElement, AvatarProps>(function Avatar(
  { className, glass, glow, loading, name, size = 'default', src, status, ...props },
  ref
) {
