...
const Badge = forwardRef<HTMLSpanElement, BadgeProps>(function Badge(
  { children, className, count, countMax = 99, dot, glass, glow, variant, ...props },
  ref
) {
  // count badge mode
  if (count !== undefined) {
...
function paletteVariant(index: number): BadgeVariant {
  return `palette-${index % 10}` as BadgeVariant
}

export { Badge, badgeVariants, paletteVariant }
