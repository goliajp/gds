...
describe('BeforeAfter', () => {
  it('renders with data-component attribute', () => {
    const { container } = render(
      <BeforeAfter before={<div>Before</div>} after={<div>After</div>} />
    )
    expect(
      container.querySelector('[data-component="before-after"]')
    ).not.toBeNull()
  })
  ...
  it('renders before and after content', () => {
    const { container } = render(
      <BeforeAfter
        before={<span data-testid="b">Before</span>}
        after={<span data-testid="a">After</span>}
      />
    )
  ...
  it('uses default initialPosition of 50', () => {
    const { container } = render(
      <BeforeAfter before={<div>B</div>} after={<div>A</div>} />
    )
    const divider = container.querySelector(
      '[data-component="before-after"] > div:last-child'
    )
  ...
  it('handles pointer events for dragging', () => {
    ...
    const dividerBefore = container.querySelector(
      '[data-component="before-after"] > div:last-child'
    )
  ...
  it('accepts a ref object', () => {
    ...
    render(<BeforeAfter before={<div>B</div>} after={<div>A</div>} ref={ref} />)
