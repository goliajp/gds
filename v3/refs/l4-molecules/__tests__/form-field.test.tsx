...
describe('FieldWrapper', () => {
  ...
  it('shows error message', () => {
    const { container } = render(
      <FieldWrapper error="Required" label="Name">
        <input />
      </FieldWrapper>
    )
  ...
  it('shows helper text when no error', () => {
    render(
      <FieldWrapper helperText="Enter your name" label="Name">
        <input />
      </FieldWrapper>
    )
  ...
  it('hides helper text when error is present', () => {
    render(
      <FieldWrapper error="Bad input" helperText="Enter your name" label="Name">
        <input />
      </FieldWrapper>
    )
