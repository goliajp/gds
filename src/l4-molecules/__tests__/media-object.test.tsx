...
describe('MediaObject', () => {
  it('renders with data-component attribute', () => {
    ...
    expect(container.querySelector('[data-component="media-object"]')).not.toBeNull()
  })

  it('renders media and children', () => {
    render(
      <MediaObject media={<span>avatar</span>}>body text</MediaObject>,
    )
  ...
  it('applies flex-row-reverse when reverse is true', () => {
    const { container } = render(
      <MediaObject media={<span>icon</span>} reverse>content</MediaObject>,
    )
