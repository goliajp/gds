...
describe('Drawer', () => {
  ...
  it('applies glass styling when glass is true', () => {
    const { container } = render(
      <Drawer open={true} onClose={vi.fn()} glass>Content</Drawer>,
    )
  ...
  it('uses custom height', () => {
    const { container } = render(
      <Drawer open={true} onClose={vi.fn()} height="lg">Content</Drawer>,
    )
    const inner = container.querySelector('.gds-ctx')
  ...
  it('uses full height', () => {
    const { container } = render(
      <Drawer open={true} onClose={vi.fn()} height="full">Content</Drawer>,
    )
    const inner = container.querySelector('.gds-ctx')
  ...
  it('calls onClose when close button clicked', async () => {
    const onClose = vi.fn()
    render(
      <Drawer open={true} onClose={onClose} title="Title">Content</Drawer>,
    )
