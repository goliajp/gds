...
describe('StatComparison', () => {
  it('renders with data-component', () => {
    const { container } = render(
      <StatComparison left={{ label: 'Before', value: 10 }} right={{ label: 'After', value: 20 }} />,
    )
    expect(container.querySelector('[data-component="stat-comparison"]')).not.toBeNull()
  })

  it('renders both labels and values', () => {
    render(<StatComparison left={{ label: 'Plan A', value: '$100' }} right={{ label: 'Plan B', value: '$200' }} />)
