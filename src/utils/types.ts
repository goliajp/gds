...
export type MergeProps<
  NativeProps,
  ComponentProps,
> = Omit<NativeProps, keyof ComponentProps> & ComponentProps
...
export type DivProps = React.HTMLAttributes<HTMLDivElement> & { className?: string }
export type ButtonProps = React.ButtonHTMLAttributes<HTMLButtonElement> & { className?: string }
...
export type MotionPreset = 'fadeIn' | 'fadeOut' | 'scaleIn' | 'scaleOut' | 'slideDown' | 'slideLeft' | 'slideRight' | 'slideUp'
