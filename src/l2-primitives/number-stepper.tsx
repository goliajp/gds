...
const NumberStepper = forwardRef<HTMLButtonElement, NumberStepperProps>(
  function NumberStepper({ direction, disabled, onClick }, ref) {
    ...
    return (
      <button
        ...
        className={cx(
          btnBase,
          isDecrement
            ? 'border-border rounded-l-[inherit] border-r'
            : 'border-border rounded-r-[inherit] border-l'
        )}
        disabled={disabled}
        onClick={onClick}
        tabIndex={-1}
