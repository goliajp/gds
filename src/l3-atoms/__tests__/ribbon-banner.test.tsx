...
describe('RibbonBanner', () => {
  it('renders with data-component attribute', () => {
    ...
    expect(
      container.querySelector('[data-component="ribbon-banner"]')
    ).not.toBeNull()
  })
  ...
  it('applies top-left position', () => {
    const { container } = render(
      <RibbonBanner text="New" position="top-left" />
    )
    const el = container.querySelector(
      '[data-component="ribbon-banner"]'
    ) as HTMLElement
  ...
  it('rotates 45deg for top-right', () => {
    const { container } = render(
      <RibbonBanner text="New" position="top-right" />
    )
    const inner = container.querySelector(
      '[data-component="ribbon-banner"] > div'
    ) as HTMLElement
  ...
  it('applies custom className', () => {
    const { container } = render(
      <RibbonBanner text="New" className="my-ribbon" />
    )
  ...
  it('forwards additional props', () => {
    const { container } = render(
      <RibbonBanner text="New" data-testid="ribbon" />
    )
