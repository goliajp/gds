...
describe('EmployeeCard', () => {
  it('renders with data-component', () => {
    ...
    expect(container.querySelector('[data-component="employee-card"]')).not.toBeNull()
  })

  it('renders name and role', () => {
    render(<EmployeeCard name="Alice Smith" role="Engineer" department="Engineering" />)
  ...
  it('renders status badge and contact info', () => {
    render(<EmployeeCard name="Bob" status="active" email="bob@golia.jp" phone="+81-90-1234" />)
