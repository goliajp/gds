...
describe('GridLayout', () => {
  ...
  it('applies fixed column count', () => {
    const { container } = render(
      <GridLayout columns={4}><div>A</div></GridLayout>,
    )
    const el = container.querySelector('[data-component="grid-layout"]') as HTMLElement
  ...
  it('applies small gap', () => {
    const { container } = render(
      <GridLayout gap="sm"><div>A</div></GridLayout>,
    )
    const el = container.querySelector('[data-component="grid-layout"]') as HTMLElement
  ...
  it('falls back to template literal for columns > 6', () => {
    const { container } = render(
      <GridLayout columns={8}><div>A</div></GridLayout>,
    )
    const el = container.querySelector('[data-component="grid-layout"]') as HTMLElement
  ...
  it('handles responsive columns with xl', () => {
    const { container } = render(
      <GridLayout columns={{ sm: 1, md: 2, lg: 3, xl: 4 }}><div>A</div></GridLayout>,
    )
    const el = container.querySelector('[data-component="grid-layout"]') as HTMLElement
  ...
  it('falls back to template literal for responsive columns > 6', () => {
    const { container } = render(
      <GridLayout columns={{ md: 8 }}><div>A</div></GridLayout>,
    )
    const el = container.querySelector('[data-component="grid-layout"]') as HTMLElement
  ...
  it('applies custom className', () => {
    const { container } = render(
      <GridLayout className="my-grid"><div>A</div></GridLayout>,
    )
    const el = container.querySelector('[data-component="grid-layout"]') as HTMLElement
